...
/**
 * MockModel class represents the mock model of Game type. This serves as a mock to
...
public class MockModel implements Game {
  ...
  public void movePlayer(Direction direction)
    ...
    log.add("Player Direction: " + direction.toString());
  }
  ...
  public void pickTreasure(Treasure treasure)
      throws IllegalStateException, IllegalArgumentException {
    log.add("Pick Treasure Type: " + treasure.toString());
  }
  ...
  public void shootArrow(int distance, Direction direction) {
    log.add("Shoot Arrow Distance: " + distance);
    log.add("Shoot Arrow Direction: " + direction);
  }
  ...
  public void checkTreasureStolen(Long time) {
    log.add("checkTreasureStolen");
  }

  @Override
  public boolean isFallen() {
    log.add("checkIsFallen");
    return false;
  }
